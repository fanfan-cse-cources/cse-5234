      ...
      <Row className={"justify-content-md-center mt-3"}>
        ...
        <Col lg="5">
          ...
          <Form as={Row}>
            ...
            <Form.Group className={"mb-3"} controlId="addr_1" onChange={(e) => {
            ...
            <Col lg="6">
              <Form.Group className={"mb-3"} controlId="city" onChange={(e) => {
            ...
            <Col lg="6">
              <Form.Group className={"mb-3"} controlId="state" onChange={(e) => {
            ...
            <Col lg="6">
              <Form.Group className={"mb-3"} controlId="zip" onChange={(e) => {
        ...
        <Col lg="5">
          ...
          <Form as={Row}>
            ...
            <Form.Group className={"mb-3"} controlId="cardnumber" onChange={(e) => {
            ...
            <Col lg="6">
              <Form.Group className={"mb-3"} controlId="cvv" onChange={(e) => {
            ...
            <Col lg="6">
              ...
              <Form.Group className={"mb-3"} controlId="expdate" onChange={(e) => {
